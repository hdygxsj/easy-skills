...
3. Register: `easy-skills register --name <name> --target cursor --source ~/.easy-skills/packages/<name>`
4. Install: `easy-skills install --name <name> --target cursor --ide cursor --scope user`
